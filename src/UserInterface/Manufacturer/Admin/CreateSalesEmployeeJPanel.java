 ...
 * @author karanmankodi
 */
public class CreateSalesEmployeeJPanel extends javax.swing.JPanel {
    ...
    Network network;
    /**
     * Creates new form CreateSalesEmployeeJPanel
     */
    public CreateSalesEmployeeJPanel(JPanel upcJPanel, Network network, Enterprise ent, UserAccount ua) {
        initComponents();
        ...
        orgNameJTextField.setText(manuEnt.getSalesOrg().getoName());
    }
    ...
    private void createAdminJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createAdminJButtonActionPerformed
        ...
        Employee emp = manuEnt.getSalesOrg().getEmployeeDirectory().newEmployee();
        emp.setName(nameJTextField.getText());
        UserAccount ua = manuEnt.getSalesOrg().getUserAccountDirectory().newUserAccount();
        ua.setEmployee(emp);
        ua.setUsername(usernameJTextField.getText());
        ua.setPassword(passwordJTextField.getText());
        ua.setRole(new ManufacturerSalesEmployeeRole());
