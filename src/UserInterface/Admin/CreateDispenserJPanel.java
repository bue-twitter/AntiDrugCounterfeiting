 ...
 * @author karanmankodi
 */
public class CreateDispenserJPanel extends javax.swing.JPanel {
     ...
     */
    public CreateDispenserJPanel(JPanel upcJPanel, Network network, Enterprise ent, UserAccount ua) {
        initComponents();
        ...
        entTypeJTextField.setText(Business.Business.DISPENSER);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("--- CREATE DISPENSER ADMIN ---");
    ...
    private void createAdminJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createAdminJButtonActionPerformed
        // TODO add your handling code here:
            ...
            Employee emp = dispEnt.getEmployeeDirectory().newEmployee();
            ...
            UserAccount ua1 = dispEnt.getUserAccountDirectory().newUserAccount();
            ua1.setEmployee(emp);
            ua1.setUsername(usernameJTextField.getText());
            ua1.setPassword(passwordJTextField.getText());
            ua1.setRole(new DispenserAdminRole());
