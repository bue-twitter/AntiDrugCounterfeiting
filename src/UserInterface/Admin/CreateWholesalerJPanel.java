 ...
 * @author karanmankodi
 */
public class CreateWholesalerJPanel extends javax.swing.JPanel {
     ...
     */
    public CreateWholesalerJPanel(JPanel upcJPanel, Network network, Enterprise ent, UserAccount ua) {
        initComponents();
        ...
        entTypeJTextField.setText(Business.Business.WHOLESALER);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("--- CREATE WHOLESALER ADMIN ---");
    ...
    private void createAdminJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createAdminJButtonActionPerformed
        // TODO add your handling code here:
            ...
            Employee emp = wholeEnt.getEmployeeDirectory().newEmployee();
            ...
            UserAccount ua1 = wholeEnt.getUserAccountDirectory().newUserAccount();
            ua1.setEmployee(emp);
            ua1.setUsername(usernameJTextField.getText());
            ua1.setPassword(passwordJTextField.getText());
            ua1.setRole(new WholesalerAdminRole());
