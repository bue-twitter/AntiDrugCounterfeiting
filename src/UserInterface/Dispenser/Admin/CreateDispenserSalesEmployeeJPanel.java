 ...
 * @author karanmankodi
 */
public class CreateDispenserSalesEmployeeJPanel extends javax.swing.JPanel {
    ...
    Network network;
    /**
     * Creates new form CreateDispenserSalesEmployeeJPanel
     */
    public CreateDispenserSalesEmployeeJPanel(JPanel upcJPanel, Network network, Enterprise ent, UserAccount ua) {
        initComponents();
        this.upcJPanel = upcJPanel;
        this.dispEnt = (DispenserEnterprise)ent;
        this.ua = ua;
        this.network = network;
        entNameJTextField.setText(dispEnt.getEnterpriseName());
        orgNameJTextField.setText(dispEnt.getSalesOrg().getoName());
    }
    ...
    private void createAdminJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createAdminJButtonActionPerformed
        ...
        Employee emp = dispEnt.getSalesOrg().getEmployeeDirectory().newEmployee();
        emp.setName(nameJTextField.getText());
        UserAccount ua = dispEnt.getSalesOrg().getUserAccountDirectory().newUserAccount();
        ua.setEmployee(emp);
        ua.setUsername(usernameJTextField.getText());
        ua.setPassword(passwordJTextField.getText());
        ua.setRole(new DispenserSalesEmployeeRole());
