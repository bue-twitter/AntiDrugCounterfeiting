 ...
 * @author karanmankodi
 */
public class WholesalerSalesEmployeeSentWorkQueueJPanel extends javax.swing.JPanel {
    ...
    Network network;
    /**
     * Creates new form WholesalerSalesEmployeeSentWorkQueueJPanel
     */
    public WholesalerSalesEmployeeSentWorkQueueJPanel(JPanel upcJPanel, Network network, Enterprise ent, UserAccount ua) {
        initComponents();
        this.ua = ua;
