 ...
 * @author karanmankodi
 */
public class CreateWholesalerShippingManagerJPanel extends javax.swing.JPanel {
    ...
    Network network;
    /**
     * Creates new form CreateWholesalerShippingManagerJPanel
     */
    public CreateWholesalerShippingManagerJPanel(JPanel upcJPanel, Network network, Enterprise ent, UserAccount ua) {
        initComponents();
        ...
        orgNameJTextField.setText(wholeEnt.getShippingOrg().getoName());
    }
    ...
    private void createAdminJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createAdminJButtonActionPerformed
        ...
        Employee emp = wholeEnt.getShippingOrg().getEmployeeDirectory().newEmployee();
        emp.setName(nameJTextField.getText());
        UserAccount ua1 = wholeEnt.getShippingOrg().getUserAccountDirectory().newUserAccount();
        ua1.setEmployee(emp);
        ua1.setUsername(usernameJTextField.getText());
        ua1.setPassword(passwordJTextField.getText());
        ua1.setRole(new WholesalerShippingManagerRole());
