 ...
 * @author karanmankodi
 */
public class CreateWholesalerInventoryManagerJPanel extends javax.swing.JPanel {
    ...
    Network network;
    /**
     * Creates new form CreateWholesalerInventoryManagerJPanel
     */
    public CreateWholesalerInventoryManagerJPanel(JPanel upcJPanel, Network network, Enterprise ent, UserAccount ua) {
        initComponents();
        ...
        orgNameJTextField.setText(wholeEnt.getInvMgmtOrg().getoName());
    }
    ...
    private void createAdminJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createAdminJButtonActionPerformed
        ...
        Employee emp = wholeEnt.getInvMgmtOrg().getEmployeeDirectory().newEmployee();
        emp.setName(nameJTextField.getText());
        UserAccount ua1 = wholeEnt.getInvMgmtOrg().getUserAccountDirectory().newUserAccount();
        ua1.setEmployee(emp);
        ua1.setUsername(usernameJTextField.getText());
        ua1.setPassword(passwordJTextField.getText());
        ua1.setRole(new WholesalerInventoryManagerRole());
