 ...
 * @author karanmankodi
 */
public class TotalFakeReportJPanel extends javax.swing.JPanel {
     ...
     */
    public TotalFakeReportJPanel(JPanel upcJPanel, Network network, Enterprise ent, UserAccount ua) {
        initComponents();
    ...
    public void refresh() {
        ...
        for (Enterprise m : network.getEnterpriseDirectory().getEnterpriseList()) {
            if (m instanceof ManufacturerEnterprise){
                ...
                row[0] = m;
                row[1] = m.getTotalFakeDrugsByManu(manuEnt);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("--- TOTAL FAKE DRUGS PER MANUFACTURER ---");
